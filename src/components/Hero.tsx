    ...
    >
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          {/* Main Title */}
          <h1 className="font-luxury text-5xl md:text-7xl lg:text-8xl text-white mb-4 relative z-20">
            Estrategias financieras
            <span className="block text-primary-glow">Personalizadas</span>
          </h1>

          {/* Personal Quote */}
          <p className="font-luxury text-xl md:text-2xl text-primary/90 mb-8 relative z-20">
            "Tu tranquilidad financiera es mi principal objetivo."
          </p>

          {/* Subtitle */}
          <p className="font-elegant text-lg md:text-xl text-white/80 mb-12 max-w-2xl mx-auto leading-relaxed relative z-20">
