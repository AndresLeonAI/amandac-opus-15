      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Button variant="premium" size="lg" className="px-10 py-6 text-lg font-elegant tracking-wide group" onClick={() => window.open('https://wa.me/573114688067?text=Hola%20Amanda,%20me%20interesa%20agendar%20una%20consulta%20privada%20para%20discutir%20mis%20objetivos%20financieros.', '_blank')}>
